...
namespace HutongGames.PlayMaker.Actions {
	...
	*/
	...
	public abstract class FsmGFHRenderAround : FsmGFStateActionGetSetHex {
		[Tooltip("The hex to render the circular shape aroud.")]
		[RequiredField]
		public FsmVector3 renderAround;
	}

	[Tooltip("Sets the hex to render the circular shape aroud.")]
	...
	[Tooltip("Gets the hex to render the circular shape aroud.")]
